...
class CvMalek extends StatelessWidget {
  const CvMalek({Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "Actuellement étudiante en deuxième année de génie logiciel avec une specialisation en informatique décisionnelle,"
                        "je suis particulièrement intéressée par l'analyse de donnees formee a utiliser divers outils technologiques,"
                        "je possède une bonne compréhension des méthodes pour traiter et analyser les informations,"
                        "Je suis engagée à appliquer mes compétentes en vue de contribuer à des projets inrovants et soutenir la prise de décisions stratégiques.",
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: <Widget>[
                          buildFormationCard(
                            context,
                            "Université Privée Nord-Américaine de Sfax",  // Title
                          ...
                          buildFormationCard(
                            context,
                            "MB Multisport-Sfax",  // Title
                            " Stagiaire Video maker",  // Subtitle
                            "Août-Septembre 2021",  // Year

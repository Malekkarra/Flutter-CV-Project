...
import 'package:fluttercvproj/inscription.page.dart';
import 'package:fluttercvproj/welcome.page.dart';
                          ...
                          children: <Widget>[
                            Checkbox(
                              ...
                              shape: RoundedRectangleBorder(
                                side: BorderSide(color: Color(0xff139f9f)),
                                borderRadius: BorderRadius.circular(5),
                              ),
                            ),
                            Text(
                              'Remember me',
                              style: TextStyle(color: Color(0xff139f9f)),
                            ),
                            Spacer(),
                            TextButton(
                              onPressed: () {
